#!/usr/bin/env python3
"""
This module contains a class called FIFOCache which is a subclass
of BaseCaching that represents a First-In-First-Out (FIFO) caching system.
"""
...
class FIFOCache(BaseCaching):
    ...
    First-In-First-Out (FIFO) caching system.

    Attributes:
        queue (list): A list to maintain the order of keys in the FIFO queue.

    """

    def __init__(self):
        """
        Initializes both an instance of FIFOCache by calling the
